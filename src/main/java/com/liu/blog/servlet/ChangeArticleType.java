...
@WebServlet("/changeArticleType")
public class ChangeArticleType extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("/changeArticleType.jsp").forward(request, response);
    }
